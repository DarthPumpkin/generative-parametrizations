...
class VisionModel(BaseModel):
    ...
    def __init__(self, vae_model_path: Path, world_model: BaseModel, z_size: int=16, batch_size: int=32, *args, **kwargs):
    ...
    def forward_sim(self, action_sequences: np.ndarray, initial_state: np.ndarray):
        ...
        return self.world_model.forward_sim(action_sequences, initial_z)
